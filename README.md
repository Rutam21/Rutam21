...
1. ❗️ Opened issue [#7](https://github.com/DagsHub/3D-model-datasets/issues/7) in [DagsHub/3D-model-datasets](https://github.com/DagsHub/3D-model-datasets)
2. ❗️ Opened issue [#6](https://github.com/DagsHub/3D-model-datasets/issues/6) in [DagsHub/3D-model-datasets](https://github.com/DagsHub/3D-model-datasets)
